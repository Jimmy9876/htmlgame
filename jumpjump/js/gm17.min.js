...
function stini() {
    ...
    tipon = 0;
    var e;
    for (e = 0; e < m; e++) bx[e] = 36 * (Math.floor(7 * Math.random()) + 1), by[e] = 40 * e, 10 < e && (by[e] = 40 * (Math.floor(9 * Math.random()) + 1)), blchk(e), 10 < 100 * Math.random() ? bc[e] = 1 : bc[e] = 2;
    mx = tx = 146;
    my = 416;
    mj = -18;
    twy = 56;
...
function gmovs() {
    ...
    s = 2;
    tcd = fac = 0;
    scr_m |= 0; /*updateShareScore(scr_m);Play68.setRankingScoreDesc(scr_m)*/ ;
...
function dp_share(t)
{
    document.title = "我在勇攀高峰跳了"+t+"米，等你来挑战！";
    alert("点击右上角分享朋友圈");
...
function Press(e) {
    ...
    switch (s) {
        ...
        case 2:
            f = e.y / wdpr | 0;
            175 < t && 365 < f ? Play68.goHome() : 35 < t && 280 < f && t < 155 && f < 325 ? (t = scr_m | 0, scr_m = t = 0, stini(), gmstini()) : 168 < t && 280 < f && t < 286 && f < 325 && setTimeout(function () {
                // Play68.shareFriend();
                dp_share(scr_m);
            }, 500)
    }
...
function lp() {
    ...
    switch (s) {
        case 1:
            ...
            twy -= wj / 3;
            0 > twy && (twy += 104);
            for (e = m - 1; 0 <= e; e--) by[e] += wj, spt2(bc[e] + 4, bx[e], by[e]), 390 < by[e] && rblk(e, 1); - 1 != sfcy && (sfcy += wj * (0 == scc), spt(scf, 0, sfcy), 323 < my && 0 < mj ? (sfcy = my + 42, 374 < my && (mj = -18, 0 < scc && (scc = 0, sfct = 416))) : (sfcy += (sfct - sfcy) / 5, 416 == sfct && 415 < sfcy && (sfcy = -1)), 0 < scc && scc--);
            if (1 < brd && 4 > brd) switch (-99 == spjpj && bdy < my && (bdy += wj), spt(bdi, bdx, bdy), brd) {
                ...
                case 3:
                    if (bdx += bds, 20 > bdx && (bdx = 20, bds = 1), 236 < bdx && (bdx = 236, bds = -1), bdy -= bdj, bdj *= .993, 3.6 > bdj && (bdj = 3.6), -60 > bdy ? (bdy = -60, bdw++, 160 < bdw && (brd = 4)) : bdw = 0, bdc++, 2 < bdc && (bdc = 0, bdi++, 36 < bdi && (bdi = 33)), 50 > Math.abs(mx + 16 - bdx) && 30 > Math.abs(my - bdy) && 6 > bdj) {
                        brd = 0;
                        for (var n, r = bdx + 32, i = bdy + 20, o = 1; 30 > o; o++) n = Math.floor(3 * Math.random()), pcf["c" + pcfi] = {
                            x: r,
                            y: i,
            ...
            if (2 < mj) {
                var l = mj,
                    c = 0;
                for (e = 0; e < m; e++)
                    if (22 > Math.abs(bx[e] - u) && by[e] - 10 < a && a < by[e] + 25) {
                        a < by[e] && (my = by[e] - 40);
                        var h = 0;
                        ...
                        if (o != bx[e]) {
                            r = bx[e] + 12;
                            i = by[e] + 9;
                            for (o = 1; 14 > o; o++) n = Math.floor(3 * Math.random()), pcf["c" + pcfi] = {
                                x: r,
                                y: i,
                                sx: 20 * -Math.random() + 10,
                                sy: 7 * -Math.random(),
            ...
            if (-99 != spjpj && (spafwt = 30, spjpa += .025, 1 < spjpa && (spjpa = 1), ctx.globalAlpha = spjpa, spt(25, 15, spjpy), ctx.globalAlpha = 1, spjpy += spjpj, 200 > spjpy))
                for (spjpj -= 5, -55 > spjpy && (spjpj = -99), spjpw = 0, i = spjpy - spjpj, o = 1; 24 > o; o++) pcf["c" + pcfi] = {
                    x: 13 * o,
                    y: i,
                    sx: 8 * Math.random() - 4,
                    sy: 3 * -Math.random(),
            ...
            switch (fvan) {
                ...
                case -1:
                    ...
                    break;
                case 1:
                    spt(31, 260, 3), fvac++, 3 < fvac && (fvac = 0, fvan *= -1)
            }
            spt2(26, 0, 399);
            spt2(42, 6, 338);
            ...
            if (0 < bp_fi) {
                ...
                for (e in bp_f)
                    if (t = bp_f[e], 1 == t.l)
                        if (-4 > t.sy && (t.x += (300 - t.x) / 9), t.y += t.sy, t.sy -= 1, spt(t.c + 9, t.x, t.y), 30 > t.y) {
                            scr_p++;
                            0 == fvbs && fvct++;
                            if (9 < fvct)
                                for (fvct = 0, fvbs = 8, fvcl = cmbc, fvan = 1, a = fvac = 0; a < m; a++)
                                    for (bc[a] = fvcl, o = 1; 6 > o; o++) pcf["c" + pcfi] = {
                                        x: bx[a] + 12,
                                        y: by[a] + 9,
                                        sx: 12 * Math.random() - 6,
                                        sy: 3 * -Math.random(),
            ...
            if (0 < pcfi) {
                o = 0;
                for (e in pcf) t = pcf[e], 1 == t.l && (t.x += t.sx, t.y += t.sy, t.sx *= t.zx, t.sy += t.zy, t.a -= .1, u = t.a, 1 < u && (u = 1), .1 > t.a || 320 < t.x || -18 > t.x || 399 < t.y ? (t.l = 0, delete pcf[e]) : (ctx.globalAlpha = u, spt(13 + 3 * t.c + t.t, t.x, t.y)), o++);
                0 == o && (pcf = {}, pcfi = 0);
                ctx.globalAlpha = 1
            }
            if (-1 != fak) switch (fak) {
                case 1:
                    for (e = 0; 3 > e; e++) o = 9 * fac + 3 * e, ctx.globalAlpha = fani1[o + 2], spt(fanf1[e], fani1[o], fani1[o + 1]);
                    fac++;
                ...
                case 2:
                    ...
                    for (e = 0; 3 > e; e++) o = 9 * fac + 3 * e, ctx.globalAlpha = fani2[o + 2], spt(fanf2[e], fani2[o], fani2[o + 1]);
                    fac++;
                    53 < fac && (fbg -= .05, 63 < fac && (fac = fak = -1));
                    ctx.globalAlpha = 1;
                    break;
                case 3:
                    o = 2 * (fac | 0), spt(56, fani3[o], fani3[o + 1]), fac = 15 < fac && 50 > fac ? fac + .5 : fac + 1, 53 < fac && 61 < fac && (fac = fak = -1)
            }
