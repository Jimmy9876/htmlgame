$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://aimpeter.xyz/games/';
...
var mebtnopenurl = 'http://aimpeter.xyz/';
window.shareData = {
    "imgUrl": "http://aimpeter.xyz/games/selang/icon.png",
    "timeLineLink": "http://aimpeter.xyz/games/selang/",
    "tTitle": "小心色狼-微营销娱乐游戏",
...
function successHandler(m, t) {
    ...
    document.title = t / 1000 + "秒！微营销娱乐游戏《小心色狼》我刚通过了！你敢不敢和我比一下？";
...
function moreHandler() {
    window.location.href = "http://aimpeter.xyz/"
};
function dp_shareHelp(t) {
    $("#share img").attr("src", "share.png");
    document.title = "我花了" + t / 1000 + "秒！微营销娱乐游戏《小心色狼》还没解开！快来帮帮我吧！";
